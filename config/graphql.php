...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'examples' => \App\GraphQL\Queries\ExamplesQuery::class
            ],
            'mutation' => [
                // ExampleMutation::class,
            ],
            'types' => [
                'Example' => \App\GraphQL\Types\ExampleType::class,
                'ExampleData' => \App\GraphQL\Types\ExampleDataType::class,
                'ExampleRelation' => \App\GraphQL\Types\ExampleRelationType::class,
            ],
            'middleware' => [],
            'method' => ['get', 'post'],
        ],
